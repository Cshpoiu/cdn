...
function copy_code_block () {
  $('pre code').each(function (i, block) {
    ...
    $(this).after('<div id="per_left"></div><div><a class="copy-code" href="javascript:" data-clipboard-target="#hljs-' + i + '" title="拷贝代码"><i class="fa fa-clipboard" aria-hidden="true"></i></a><div>')
  })
...
function add_copyright () {
  ...
  function setClipboardText (event) {
    ...
    //+ '著作权归作者所有。<br>' + '商业转载请联系作者获得授权，非商业转载请注明出处。<br>' + '作者：' + mashiro_option.author_name + '<br>' + '链接：' + window.location.href + '<br>' + '来源：' + mashiro_option.site_name + '<br><br>' 
    ...
    MN: function () {
      ...
      $(window).scroll(function () {
        if ($(this).scrollTop() > offset) {
            ...
            $('#rightside').css({ opacity: '0', transform: '' })
